    ...
    <body>
        ...
        <div class="container">
            ...
            <form action="aggiungi" method="POST" id="form" style="max-width: 700px; margin-left: auto; margin-right: auto;" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-9">
                        <input type="text" class="form-control" name="nome" id="nome" required pattern="[A-Za-z}{1,50}">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-9">
                        <input type="text" class="form-control" name="prezzo" id="prezzo" placeholder="0,00" required pattern="[0-9]+,[0-9]{2}">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-9">
                        <input type="file" class="form-control-file" id="immagine" aria-describedby="fileHelp" name="immagine" required>
                    </div>
                </div>
                ...
                <input type="submit" class="btn btn-success" id="submit-btn" value="Conferma">
        ...
        <div class="modal fade" id="aggiungi-ingrediente" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <form id="form-ing" class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group row">
                            ...
                            <div class="col-10">
                                <input type="text" class="form-control" name="nome-ing" id="nome-ing" required pattern="[A-Za-z]{1,50}">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <input type="text" class="form-control" name="sovrapprezzo" id="sovrapprezzo" placeholder="0,00" required pattern="[0-9]+,[0-9]{2}">
                            </div>
                        </div>

                    </div>
                    <div class="modal-footer">
                        <input type="submit" class="btn btn-success" id="salva-ing" value="Salva">
                    </div>
