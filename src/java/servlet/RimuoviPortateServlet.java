 ...
 * @author ciro
 */
@WebServlet(name = "RimuoviPortateServlet", urlPatterns = {"/rimuoviportate"})
public class RimuoviPortateServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(authAs == null) {
            ...
            Collection<Piatto> piatti = tm.getPiattiRimozione();
            request.setAttribute("piatti", piatti);
            request.getRequestDispatcher("rimuoviportata.jsp")
                    .forward(request, response);
